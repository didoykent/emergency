                    ...
                    <v-list-item-group>
                      <template v-for="(item, index) in items">
                        <v-list-item :key="item.title">
                          <template>
                            <v-list-item-avatar>
                              <v-icon x-large color="#1976d2">mdi-alpha-{{item.title.charAt(0).toLowerCase()}}-circle</v-icon>
                            </v-list-item-avatar>
      ...
      <v-dialog v-model="inboxDialog" max-width="1000" max-height="500">
        <v-card>
          ...
          <v-container fluid>
            <v-row>
              <v-col cols="12" sm="3">
                  <p class="title font-weight-regular">KR Admin Name</p>
              </v-col>
              <v-col cols="12" sm="9">
